...
public class SavedItemDaoImpl implements SavedItemDao {
    ...
    public SavedItem addSavedItem(SavedItem savedItem) {
        try {
            ...
            jdbcTemplate.update(connection -> createSavedItemStatement(savedItem, connection), holder);
            savedItem.setId(Optional.ofNullable(holder.getKey())
                .map(Number::longValue)
                .orElseThrow(() -> new CRUDException("Error during an savedItem creation: " +
