...
public class WarehouseDaoImpl implements WarehouseDao {
    ...
    private PreparedStatement createWarehouseStatement(Warehouse warehouse, Connection connection) throws SQLException {
        int i = 0;
        PreparedStatement statement = connection.prepareStatement(QueryToWarehouse.SQL_CREATE_USER,
    ...
    public List<Warehouse> findAll() {
        try {
            return jdbcTemplate.query(QueryToWarehouse.SQL_SELECT_ALL_WAREHOUSES, warehouseRowMapper);
    ...
    public Warehouse findById ( long id){
        try {
            return jdbcTemplate.queryForObject(QueryToWarehouse.SQL_SELECT_WAREHOUSE_BY_ID, warehouseRowMapper, id);
    ...
    @Override
        ...
        try{
        int status = 0;
        status = jdbcTemplate.update(QueryToWarehouse.SQL_UPDATE_WAREHOUSE,
        ...
        int status;
        try{
            status = jdbcTemplate.update(QueryToWarehouse.SQL_DELETE_WAREHOUSE, false,id);
        }
        catch (DataAccessException e){
    ...
    class QueryToWarehouse {
            ...
            static final String SQL_UPDATE_WAREHOUSE = "UPDATE warehouses SET" +
                "name= ?, info = ?," + "capacity = ?, is_bottom = ?,top_warehouse_id = ?" +
                "active = ? WHERE id = ?";
