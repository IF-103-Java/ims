...
public class UserDaoImpl implements UserDao {
    ...
    public User create(User user) {
        try {
            ...
            jdbcTemplate.update(connection -> getPreapredStatement(user, connection), holder);
            ...
            throw new CRUDException("Error during `create` {id = " + user.getId() + "}");
        }
    }
    ...
    public User findById(Long id) {
        try {
            ...
            throw new UserNotFoundException("Failed to obtain user during `select` {id = " + id + "}");
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {id = " + id + "}");
        }
    ...
    public User findByAccountId(Long accountId) {
        try {
            ...
            throw new UserNotFoundException("Failed to obtain user during `select` {accountId = " + accountId + "}");
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {accountId = " + accountId + "}");
        }
    ...
    public List<User> findAll() {
        try {
            ...
            throw new CRUDException("Error during `select * `");
        }
    }
    ...
    public User findByEmail(String email) {
        try {
            ...
            throw new UserNotFoundException("Failed to obtain user during `select` {email = " + email + "}");
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {email = " + email + "}");
        }
    }
    ...
    public User update(User user) {
        ...
        try {
            ...
            throw new CRUDException("Error during `update` {id = " + user.getId() + "}");
        }
        if (status == 0)
    ...
    public boolean softDelete(Long id) {
        ...
        try {
            ...
            throw new CRUDException("Error during soft `delete` {id = " + id + "}");
        }
        if (status == 0)
            throw new

                UserNotFoundException("Failed to obtain user during soft `delete` {id = " + id + "}");
    ...
    public boolean hardDelete(Long id) {
        ...
        try {
            ...
            throw new CRUDException("Error during hard `delete` {id = " + id + "}");
        }
        if (status == 0) {
    ...
    public boolean updatePassword(Long id, String newPassword) {
        ...
        try {
            ...
            throw new CRUDException("Error during hard `update` password {id = " + id + "}");
        }
        if (status == 0)
    ...
    public User findByEmailUUID(String emailUUID) {
        try {
            ...
            throw new UserNotFoundException("Failed to obtain user during `update` password {emailUUID = " + emailUUID + "}");
        } catch (DataAccessException e) {
            throw new CRUDException("Error during hard `select` {emailUUID = " + emailUUID + "}");
        }
    }

    private PreparedStatement getPreapredStatement(User user, Connection connection) throws SQLException {
