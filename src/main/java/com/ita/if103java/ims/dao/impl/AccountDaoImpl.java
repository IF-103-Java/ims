...
public class AccountDaoImpl implements AccountDao {
    ...
    @Autowired
    public AccountDaoImpl(DataSource dataSource, AccountRowMapper accountRowMapper, AccountTypeDaoImpl accountTypeDaoImpl, GeneratedKeyHolderFactory generatedKeyHolderFactory) {
