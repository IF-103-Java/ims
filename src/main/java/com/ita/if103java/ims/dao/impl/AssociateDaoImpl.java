...
public class AssociateDaoImpl implements AssociateDao {
    ...
    @Autowired
    public AssociateDaoImpl(AssociateRowMapper associateRowMapper,
    ...
    public Associate create(Long accountId, Associate associate) {
        try {
            associate.setId(createWithAutogeneratedId(Long.class,
                (keyHolder) -> jdbcTemplate.update(connection -> createStatement(accountId, associate, connection), keyHolder),
    ...
    public Associate findById(Long accountId, Long id) {
        try {
            ...
            throw new AssociateEntityNotFoundException("Failed to obtain associate during `select`, id = " + id, e);
        } catch (DataAccessException e) {
