...
public class UserDaoImpl implements UserDao {
    ...
    private PreparedStatement createStatement(User user, String encryptedPassword, LocalDateTime localDateTime,
        ...
        preparedStatement.setString(9, emailUUID);
    ...
    public User create(User user) {
        try {
            ...
            jdbcTemplate.update(connection -> createStatement(user, encryptedPassword, currentDate, emailUUID, connection), holder);
