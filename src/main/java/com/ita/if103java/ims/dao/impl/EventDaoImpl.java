...
public class EventDaoImpl implements EventDao {
    ...
    public Event create(Event event) {
        try {
            ...
            throw new CRUDException("Error during `create` {id = " + event.getId() + "}", e);
        }
    }
    ...
    public Event findById(Long id) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {id = " + id + "}", e);
        } catch (DataAccessException e) {
    ...
    public Event findByTransactionId(Long transactionId) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {transactionId = " + transactionId + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {transactionId = " + transactionId + "}", e);
        }
    }
    ...
    public List<Event> findByAccountId(Long accountId) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {accountId = " + accountId + "}", e);
        } catch (DataAccessException e) {
    ...
    public List<Event> findByWarehouseId(Long warehouseId) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {warehouseId = " + warehouseId + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {warehouseId = " + warehouseId + "}", e);
        }
    }
    ...
    public List<Event> findByAuthorId(Long authorId) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {authorId = " + authorId + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {authorId = " + authorId + "}", e);
        }
    }
    ...
    public List<Event> findByAccountIdAndType(Long accountId, EventType type) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {accountId = " + accountId + ", type = " + type + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {accountId = " + accountId + ", type = " + type + "}", e);
        }
    }
    ...
    public List<Event> findByWarehouseIdAndType(Long warehouseId, EventType type) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {warehouseId = " + warehouseId + ", type = " + type + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {warehouseId = " + warehouseId + ", type = " + type + "}", e);
        }
    }
    ...
    public List<Event> findByWarehouseIdAndDate(Long warehouseId, ZonedDateTime date) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {warehouseId = " + warehouseId + ", date = " + date + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {warehouseId = " + warehouseId + ", date = " + date + "}", e);
        }
    }
    ...
    public List<Event> findByAccountIdAndDate(Long accountId, ZonedDateTime date) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {accountId = " + accountId + ", date = " + date + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {accountId = " + accountId + ", date = " + date + "}", e);
        }
    }
    ...
    public List<Event> findByWarehouseIdAndWithinDates(Long warehouseId, ZonedDateTime after, ZonedDateTime before) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {warehouseId = " + warehouseId + ", after = " + after + ", before = " + before + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {warehouseId = " + warehouseId + ", after = " + after + ", before = " + before + "}", e);
        }
    }
    ...
    public List<Event> findByAccountIdAndWithinDates(Long accountId, ZonedDateTime after, ZonedDateTime before) {
        try {
            ...
            throw new EventNotFoundException("Failed to obtain event during `select` {accountId = " + accountId + ", after = " + after + ", before = " + before + "}", e);
        } catch (DataAccessException e) {
            throw new CRUDException("Error during `select` {accountId = " + accountId + ", after = " + after + ", before = " + before + "}", e);
        }
    }
