...
public class ItemDaoImpl implements ItemDao {
    ...
    public Item addItem(Item item) {
        try {
            ...
            jdbcTemplate.update(connection -> createItemStatement(item, connection), holder);
            item.setId(Optional.ofNullable(holder.getKey())
                .map(Number::longValue)
                .orElseThrow(() -> new CRUDException("Error during an item creation: " +
